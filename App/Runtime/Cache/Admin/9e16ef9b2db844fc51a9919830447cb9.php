...
<body>
    ...
    <div class="login_in" >
        <input name="username" type="text" placeholder="请输入用户名" class="form-control" /> <br>
        <input name="password" type="password" placeholder="请输入密码" class="form-control" /><br>
        <button class="btn btn-primary" id="loginSubmit">提交</button>
    </div>
