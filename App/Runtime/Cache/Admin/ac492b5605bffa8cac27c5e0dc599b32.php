    ...
    <div class="bodyRight category">
        ...
        <form class="form-horizontal">
            <table class="table table-bordered menu_manage" >
                ...
                <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><input type="checkbox" class="article-input" name="delete[]" data-uid="<?php echo ($vo["id"]); ?>" /></td><td><?php echo ($vo["id"]); ?></td><td><?php echo ($vo["title"]); ?></td><td><?php echo ($vo["pid"]); ?></td><td><?php echo ($vo["description"]); ?></td><td><?php echo ($vo["author"]); ?></td><td><?php echo ($vo["creattime"]); ?></td><td><?php echo ($vo["modifytime"]); ?></td><td> <?php if($vo["status"] == 1 ): ?>开启 <?php else: ?> 关闭<?php endif; ?> </td><td><a href="/Admin/Recommend/edit/id/<?php echo ($vo["id"]); ?>">编辑</a> <a href="/Admin/Recommend/closeRecommend/id/<?php echo ($vo["id"]); ?>">关闭</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </table>
